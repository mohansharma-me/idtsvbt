...
-- Database: `accounts`
--
CREATE DATABASE `accounts` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `accounts`;
...
-- Database: `clgmg`
--
CREATE DATABASE `clgmg` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `clgmg`;
...
-- Database: `results`
--
CREATE DATABASE `results` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `results`;
